...
import { schoolWideStats } from "@/lib/data";
...
const ROCKET_STAGES = [
  {
    ...
    resources: [
      ...
      },
      {
        ...
        details: "Write a constitution that will pass school approval.",
        type: "template",
        downloads: 623,
        fileSize: "340 KB",
        format: "DOCX",
      },
      {
        ...
        details:
          "Checklist for advisor confirmation and school policy alignment.",
        type: "checklist",
        downloads: 215,
        fileSize: "450 KB",
        format: "PDF",
  ...
  },
  {
    ...
    resources: [
      {
        ...
        details:
          "How to promote your club on Instagram, Discord, and other platforms.",
        type: "guide",
        downloads: 567,
        fileSize: "1.8 MB",
        format: "PDF",
      ...
      {
        id: "lo-2",
        title: "Club Fair Preparation",
        details: "Everything you need for a successful club fair booth.",
        type: "checklist",
        downloads: 312,
        fileSize: "3.2 MB",
        format: "PDF",
      },
      {
        ...
        details:
          "Keep members engaged with events, recognition, and meaningful activities.",
        type: "guide",
        downloads: 245,
        fileSize: "720 KB",
        format: "PDF",
      ...
      {
        id: "lo-4",
        title: "Recruitment Flyer Templates",
        details: "Customizable flyer designs for announcing your club.",
        type: "template",
        downloads: 489,
        fileSize: "5.4 MB",
        format: "PDF",
    ...
    hubLinks: [
      { href: "/directory", label: "Club Directory", icon: Search },
      { href: "/guides", label: "Club Guides", icon: FileText },
      { href: "/hub/collaborate", label: "Find Collaborators", icon: Zap },
    ...
    resources: [
      {
        ...
        details:
          "Agenda templates, parliamentary procedure basics, and engagement techniques.",
        type: "template",
        downloads: 421,
        fileSize: "950 KB",
        format: "DOCX",
      },
      {
        ...
        details:
          "Standard format for documenting meeting discussions and decisions.",
        type: "template",
        downloads: 445,
        fileSize: "120 KB",
        format: "DOCX",
      ...
      {
        id: "ob-3",
        title: "Officer Roles & Responsibilities",
        details:
          "Define clear roles for President, VP, Secretary, Treasurer, and more.",
        type: "handbook",
        downloads: 278,
        fileSize: "2.1 MB",
        format: "PDF",
      },
      {
        ...
        details:
          "Strategies for handling disagreements between members, officers, and advisors.",
        type: "guide",
        downloads: 134,
        fileSize: "520 KB",
        format: "PDF",
    ...
    resources: [
      {
        ...
        details:
          "Comprehensive checklists for planning club events of any size.",
        type: "template",
        downloads: 398,
        fileSize: "1.5 MB",
        format: "DOCX",
      },
      {
        ...
        details:
          "Proven strategies including bake sales, sponsorships, and grant writing.",
        type: "guide",
        downloads: 534,
        fileSize: "2.3 MB",
        format: "PDF",
      ...
      {
        id: "ex-3",
        title: "Budget Management Sheet",
        details:
          "Track club finances, submit purchase requests, and maintain transparency.",
        type: "template",
        downloads: 267,
        fileSize: "180 KB",
        format: "DOCX",
      ...
      {
        id: "ex-4",
        title: "Sponsorship Outreach Kit",
        details: "Template emails and tips for approaching local businesses.",
        type: "template",
        downloads: 312,
        fileSize: "900 KB",
        format: "DOCX",
    ...
    resources: [
      {
        ...
        details:
          "How to transition leadership smoothly when officers graduate or step down.",
        type: "guide",
        downloads: 98,
        fileSize: "380 KB",
        format: "PDF",
      },
      {
        ...
        details:
          "End-of-year report template showcasing achievements and impact.",
        type: "template",
        downloads: 187,
        fileSize: "650 KB",
        format: "DOCX",
      ...
      {
        id: "mc-3",
        title: "Competition Prep Timeline",
        details:
          "12-week countdown with weekly milestones and practice schedules.",
        type: "guide",
        downloads: 201,
        fileSize: "600 KB",
        format: "PDF",
      ...
      {
        id: "mc-4",
        title: "Judging Criteria Overview",
        details:
          "Understand how TSA and other organizations score student projects.",
        type: "handbook",
        downloads: 234,
        fileSize: "520 KB",
        format: "PDF",
...
const PDF_CONTENT: Record<string, { pages: ResourcePage[] }> = {
  ...
  "ob-3": {
    pages: [
      ...
      {
        title: "Additional Roles & Election Process",
...
function getResourcePages(resource: ResourceItem): ResourcePage[] {
  ...
  return [
    {
      title: `${resource.title} — Overview`,
      body: `Stage: ${stageTitle} (${stageSubtitle})\nType: ${resource.type.toUpperCase()}\nFormat: ${resource.format}\n\nPurpose\n${resource.details}\n\nWhat this document includes\n• A practical overview you can use immediately with your leadership team\n• Clear outcomes and implementation goals tied to the ${stageTitle} stage\n• Suggested adaptation notes for clubs of different sizes and experience levels\n\nWho should use this\n• Founders and officers preparing plans for the current semester\n• New members onboarding into core club processes\n• Advisors reviewing readiness before approval or launch`,
    },
    {
      title: `${resource.title} — Action Plan`,
      body: `Planning Focus Areas\n• Governance: Assign owners, timelines, and accountability checkpoints\n• Execution: Break the work into weekly actions and meeting agenda items\n• Communications: Keep members informed using concise updates and reminders\n• Measurement: Define success criteria before beginning implementation\n\nSuggested 4-Week Rollout\nWeek 1: Orientation and baseline check\nWeek 2: Pilot one process with a small team\nWeek 3: Collect feedback, adjust, and document changes\nWeek 4: Standardize the process and train all members\n\nImplementation keywords\n${topicWords || resource.title}`,
    },
    {
      title: `${resource.title} — Checklist & Documentation`,
      body: `Completion Checklist\n☐ Confirm advisor and officer alignment on scope\n☐ Publish a member-facing summary in your shared channel\n☐ Store templates and supporting files in the club drive\n☐ Add recurring review dates to the team calendar\n☐ Capture improvements after the first full cycle\n\nDocumentation Guidance\nMaintain version history and date-stamped updates. Save examples, meeting notes, and decisions made while using this resource. This helps with continuity during officer transitions and strengthens annual reporting.\n\nSupport\nIf your club needs help adapting this material, use ClubConnect hub tools or reach out to chapter mentors for stage-specific guidance.`,
    },
  ];
}
...
async function downloadAsPdf(resource: ResourceItem, pages: ResourcePage[]) {
  ...
  for (let i = 0; i < pages.length; i += 1) {
    ...
    page.drawText("ClubConnect Resource Library", {
      x: margin,
      y,
      size: 11,
      font: bold,
    ...
    y -= 20;
    page.drawText(
      `Source: ${resource.title} | Format: PDF | Page ${i + 1} of ${pages.length}`,
      {
        x: margin,
        y,
        size: 9,
    ...
    const paragraphBlocks = data.body.split("\n");
    for (const block of paragraphBlocks) {
      if (!block.trim()) {
        y -= 8;
        continue;
      }
      const lines = wrapByWidth(block, availableWidth, (value) =>
        regular.widthOfTextAtSize(value, 10),
      );
  ...
  triggerDownload(blob, `${sanitizeFileName(resource.title)}.pdf`);
}

async function downloadAsDocx(resource: ResourceItem, pages: ResourcePage[]) {
  ...
  children.push(
    new Paragraph({
      ...
      children: [
        new TextRun({ text: "ClubConnect Resource Library", bold: true }),
      ],
    }),
  );
  children.push(
    new Paragraph({
      children: [new TextRun(`Resource: ${resource.title}`)],
    }),
  );
  children.push(
    new Paragraph({
  ...
  triggerDownload(blob, `${sanitizeFileName(resource.title)}.docx`);
}

async function downloadResource(resource: ResourceItem): Promise<void> {
  const pages = getResourcePages(resource);

  try {
    if (resource.format === "DOCX") {
      await downloadAsDocx(resource, pages);
      return;
    }
    if (resource.format === "PDF") {
      await downloadAsPdf(resource, pages);
      return;
    }
  } catch {
    // Fall through to text fallback so download still succeeds.
  }
  ...
  triggerDownload(
    fallbackBlob,
    `${sanitizeFileName(resource.title)}_resource.txt`,
  );
}
...
const stageRocketColors: Record<
  string,
  {
    body: string;
    nose: string;
...
export default function ResourcesPage() {
  ...
  const currentStage =
    ROCKET_STAGES.find((s) => s.id === activeStage) || ROCKET_STAGES[0];
  const allResources = ROCKET_STAGES.flatMap((s) => s.resources);

  const filteredResources = currentStage.resources
    .filter((r) => {
  ...
  const previewPages = popup ? getResourcePages(popup) : [];
      ...
      <HeroSection align="left" contentClassName="!max-w-full">
        <div className="flex items-center gap-6">
          <div className="shrink-0">
            ...
            <p className="hero-description max-w-lg text-sm">
              Your launch pad for club success &mdash; guides, templates, tools,
              and smart recommendations organized by growth stage.
            </p>
          </div>
          <div className="hidden sm:grid grid-cols-3 gap-3 ml-auto">
            ...
            <div className="bg-secondary-500/30 border border-secondary-400/30 px-6 py-4 text-center min-w-[110px]">
              <p className="text-3xl font-heading font-bold text-secondary-300">
            ...
            <div className="bg-accent-500/30 border border-accent-400/30 px-6 py-4 text-center min-w-[110px]">
              <p className="text-3xl font-heading font-bold text-accent-300">
                {schoolWideStats.totalClubs}
              </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3">
        <div className="space-y-3">
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-2 overflow-x-auto pb-1">
              {ROCKET_STAGES.map((stage) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`w-7 h-7 rounded-md bg-gradient-to-br ${stage.color} text-white flex items-center justify-center`}
                    >
                      <Icon size={14} />
                    </div>
                    <span>
            ...
            {}
            <div
              className={`overflow-hidden border ${currentStage.borderColor}`}
            >
              <div
                className={`bg-gradient-to-r ${currentStage.color} text-white p-5`}
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <span className="text-[10px] font-bold uppercase tracking-widest text-white/70">
                      STAGE {currentStage.phase}
                    </span>
                    <h2 className="text-xl font-heading font-bold">
                      {currentStage.title} &mdash; {currentStage.subtitle}
                    </h2>
                    <p className="text-sm text-white/80 mt-1">
                      {currentStage.resources.length} resources &bull;{" "}
                      {currentStage.hubLinks.length} tools
                    </p>
                  </div>
                </div>
                {/* Inline filters */}
                <div className="mt-3 flex flex-wrap items-center gap-2">
                  <select
                    ...
                    className="bg-white/15 border border-white/25 text-white text-xs py-1.5 px-2 focus:outline-none focus:border-white/50 [&>option]:text-neutral-800"
                  >
                    {["All", "guide", "template", "checklist", "handbook"].map(
                      (o) => (
                        <option key={o} value={o}>
                          {o === "All"
                            ? "All Types"
                            : o.charAt(0).toUpperCase() + o.slice(1) + "s"}
                        </option>
                      ),
                    )}
                  </select>
                  ...
                  <span className="ml-auto text-[10px] text-white/70">
                    ...
                    {currentStage.resources.length} resources
                  </span>
                </div>
                <div className="mt-4 flex items-center gap-2">
                  <div className="flex-1 relative">
                    ...
                    <input
                      ...
                      className="w-full pl-9 pr-4 py-2.5 bg-white/10 border border-white/20 text-sm text-white placeholder:text-white/50 focus:border-white/50 focus:bg-white/15 focus:outline-none transition-colors"
                    />
                  </div>
                  <button
                    type="button"
                    onClick={() => setSearchQuery("")}
                    className="px-4 py-2.5 bg-white text-primary-700 text-xs font-bold hover:bg-white/90 disabled:opacity-50 transition-colors"
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
              {currentStage.hubLinks.map((link, idx) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`w-7 h-7 rounded-md bg-gradient-to-br ${gradientClass} text-white flex items-center justify-center shrink-0`}
                    >
                      <Icon size={13} />
                    </div>
                    <span className="font-semibold text-xs text-primary-800 truncate">
                      {link.label}
                    </span>
                  </Link>
                );
            ...
            {searchQuery.trim() && globalSearch.length > 0 && (
              <div className="card  p-3 border border-secondary-200 bg-secondary-50/50">
                <h3 className="font-bold text-xs text-yellow-800 mb-2 flex items-center gap-1">
                  <Search size={12} /> Results across all stages (
                  {globalSearch.length})
                </h3>
                <div className="grid sm:grid-cols-2 gap-2">
                  {globalSearch.map((item) => (
                    <button
                      ...
                      className="border border-yellow-200  p-2 hover:bg-white transition-all text-left"
                    >
                      <span
                      ...
                      <h4 className="font-bold text-xs text-primary-700 mt-1">
                        {item.title}
                      </h4>
                    </button>
                  ))}
            ...
            <div>
              <h3
                className={`text-sm font-bold ${currentStage.textColor} mb-2 flex items-center gap-1`}
              >
                <FileText size={14} /> Downloadable Resources
              </h3>
              <div className="grid sm:grid-cols-2 gap-3">
                {filteredResources.map((item) => (
                  <button
                    key={item.id}
                    onClick={() => setPopup(item)}
                    className="card  p-4 hover:border-primary-300 text-left group hover:shadow-sm transition-all"
                  >
                    ...
                    <h3 className="font-bold text-sm text-primary-700 group-hover:text-primary-600">
                      {item.title}
                    </h3>
                    ...
                    <div className="mt-2 flex items-center justify-between text-[10px] text-neutral-400">
                      <span>
                        {item.format} &middot; {item.fileSize}
                      </span>
            ...
            <div className="card  p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 bg-gradient-to-r from-primary-50 to-secondary-50 border border-primary-200">
              <div>
                <h3 className="text-base font-heading font-bold text-primary-600">
                  Ready to Launch Your Club?
                </h3>
                <p className="text-xs text-neutral-600">
                  Join hundreds of student leaders building amazing communities.
                </p>
              </div>
            ...
            <div className="card p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-200">
              <div>
                <h3 className="text-base font-heading font-bold text-green-700 flex items-center gap-2">
                  <Upload size={16} /> Know a Community Resource?
                </h3>
                <p className="text-xs text-neutral-600">
                  Help grow our hub — suggest non-profits, support services,
                  events, and programs for the community.
                </p>
              </div>
              <Link
                href="/propose"
                className="btn-primary text-sm flex items-center gap-1 px-4 py-2 bg-green-600 hover:bg-green-700 border-green-600 shrink-0"
              >
          ...
          >
            <div className="p-5 overflow-y-auto flex-1 min-h-0">
              <div className="flex items-start justify-between gap-3 mb-3">
                <div>
                  <span
                    className={`inline-flex items-center gap-1 px-2 py-0.5 rounded text-[10px] font-medium ${typeColors[popup.type]}`}
                  >
                    {typeIcons[popup.type]} {popup.type}
                  </span>
                  <h2 className="mt-2 text-lg font-heading font-bold text-primary-700">
                    {popup.title}
                  </h2>
                </div>
                <button
                  ...
                  className="p-1  hover:bg-neutral-100 text-neutral-400 hover:text-neutral-600"
                >
                  <X size={18} />
                </button>
              </div>
              ...
              <div className="mt-3 grid grid-cols-3 gap-2 text-center">
                <div className="bg-primary-50  p-2">
                  ...
                  <p className="text-[10px] text-neutral-500">Downloads</p>
                </div>
                <div className="bg-primary-50  p-2">
                  <p className="text-base font-bold text-primary-700">
                    {popup.format}
                  </p>
                  <p className="text-[10px] text-neutral-500">Format</p>
                </div>
              ...
              <div className="mt-4">
                {!showPreview ? (
                  ...
                  >
                    <Eye size={14} /> Preview Document ({previewPages.length}{" "}
                  ...
                  <div className="border-2 border-neutral-200  overflow-hidden">
                    ...
                    <div className="bg-neutral-100 p-4">
                      <div
                        className="bg-white shadow-lg mx-auto max-w-lg p-6 min-h-[300px] border border-neutral-200"
                        style={{
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between border-b-2 border-primary-600 pb-2 mb-4">
                          <div className="flex items-center gap-2">
                            <div className="w-6 h-6 bg-primary-600 rounded flex items-center justify-center text-white text-[8px] font-bold">
                              CC
                            </div>
                            <span className="text-[9px] font-semibold text-primary-700 tracking-wide uppercase">
                              ClubConnect Resource Library
                            </span>
                          </div>
                    ...
                    {previewPages.length > 1 && (
                      <div className="bg-neutral-800 px-4 py-2 flex items-center justify-between">
                        ...
                        <button
                          onClick={() =>
                            setPreviewPage((p) =>
                              Math.min(previewPages.length - 1, p + 1),
                            )
                          }
              ...
              <div className="mt-4 space-y-2">
                <button
                  onClick={() => void downloadResource(popup)}
                  className="btn-primary w-full flex items-center justify-center gap-2  text-sm"
                >
                  <Download size={14} /> Download {popup.format}
                </button>
              </div>
            </div>
          </div>
