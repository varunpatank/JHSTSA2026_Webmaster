      ...
      <section className="relative bg-primary-500 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-neutral-200">
            documentation and citations for clubconnect websuite
          </p>
        </div>
      </section>
        ...
        <div className="bg-white border border-neutral-200 shadow-card mb-12">
          ...
          <div className="p-6">
            <p className="text-neutral-700 leading-relaxed">
              ...
              <span className="font-semibold text-primary-500">Next.js</span>, a
              modern framework built on top of React optimized for efficiency
              and fast render times. On top of this, this website utilizes{" "}
              <span className="font-semibold text-primary-500">
                TailwindCSS
              </span>
              , a framework allowing for shorthand CSS to be written directly in
              components. Non-standard components and the theming of the site
              are done by the work of our team. This site follows current WCAG
              ...
              contrast ratio rating. All images used are sourced from Unsplash
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <ul className="space-y-3">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <code className="bg-neutral-100 px-2 py-0.5 text-sm">
                      next/image
                    </code>{" "}
                    : Optimized image component for Next.js applications.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-secondary-500 mt-1">•</span>
                  <span>
                    ...
                    : Client-side navigation component for Next.js.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-secondary-500 mt-1">•</span>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    : Typed superset of JavaScript for better developerment
                    experience.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    : Utility-first CSS framework for rapid UI developement.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-secondary-500 mt-1">•</span>
          ...
          <div className="p-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {imageLinks.map((image, index) => (
                <div
                  key={index}
                  className="border border-neutral-200 p-3 bg-neutral-50"
                >
                  <a
